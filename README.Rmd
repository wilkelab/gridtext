...
[![Coverage Status](https://img.shields.io/codecov/c/github/wilkelab/gridtext/master.svg)](https://app.codecov.io/github/wilkelab/gridtext?branch=master)
...
This project received [financial support](https://r-consortium.org/all-projects/2018-group-2.html#next-generation-text-layout-in-grid-and-ggplot2) from the [R consortium.](https://r-consortium.org/)
