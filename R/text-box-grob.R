...
#' library(grid)
#' grid.newpage()
#' grid.draw(text_box_grob("Some text **in bold.**"))
#' @export
text_box_grob <- function(text, width = NULL, height = NULL,
  ...
  if (is.null(width)) {
    ...
    vbox <- bl_make_vbox(boxlist, width_pt = 100, hjust = hjust, vjust = vjust, width_policy = "relative")
  }
